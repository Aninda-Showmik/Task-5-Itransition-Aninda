...
const app = express();
const PORT = process.env.PORT || 3000; // Use Render's assigned PORT or default 3000
...
const generateBooks = (locale, seed, numBooks, likes, reviews, page) => {
    ...
    faker.seed(seed + page + Math.floor(likes * 10) + Math.floor(reviews * 10)); // Ensure books change when likes/reviews change
